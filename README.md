# Tech Debt Burndown website (on Cloudflare Pages)
...
Just pasting in a URL isn't helpful SEO-wise, and it's also less delightful for the reader. For example, `[Jill’s awesome talk about recruiting](http://www.thing.com/stuff)` is better than `http://www.thing.com/stuff`
...
Thanks to [Arrested DevOps](https://www.arresteddevops.com/) for making their [website source](https://github.com/arresteddevops/ado-hugo) available, and particularly [Matt Stratton](https://github.com/mattstratton) for the [Castanet Theme](https://github.com/mattstratton/castanet).
